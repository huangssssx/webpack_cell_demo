...
var BaseClass = function () {
	function BaseClass() {
		//		console.log("this is BaseClass");

		_classCallCheck(this, BaseClass);
	}

	BaseClass.prototype.Ajax = function Ajax() {

		//		console.log("this is BaseClass`s Ajax function");
	};
...
var $ = __webpack_require__(335);

var Index = function (_BaseClass) {
	_inherits(Index, _BaseClass);
	...
	function Index() {
		...
		_this.loadAction = function (actionList, callback) {
			var t = _this;
			var pluginObject = {};
			var isLoaded = false;
			var flags = [0, 0];
			...
			if (actionList.indexOf("login") != -1) {
				__webpack_require__.e/* require.ensure */(1).then((function (require) {
					$.extend(t, pluginObject, __webpack_require__(336));
					flags[0] = 1;
					checkReady();
			...
			if (actionList.indexOf("register") != -1) {
				__webpack_require__.e/* require.ensure */(0).then((function (require) {
					$.extend(t, pluginObject, __webpack_require__(337));
					flags[1] = 1;
					checkReady();
				}).bind(null, __webpack_require__))["catch"](__webpack_require__.oe);
			}
	...
	Index.prototype.config = function config(options) {
		this.options = options;
	};

	Index.prototype.ready = function ready(callback) {
		var t = this;
...
var Utils = function () {
	...
	//通过class获取dom
	Utils.prototype.getDomByClass = function getDomByClass(className) {
